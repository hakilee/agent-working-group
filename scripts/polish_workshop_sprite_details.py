...
def draw_human_frame(pal: dict[str, Color], row: int, frame_index: int) -> Image.Image:
    ...
    if row == 2:
        far = tuple(max(0, int(c * 0.68)) for c in pants[:3]) + (255,)
        if frame_index % 4 == 1:
            near = [(7, 24), (8, 24), (7, 25), (8, 25), (7, 26), (8, 26), (8, 27), (9, 27)]
            rear = [(5, 24), (5, 25), (5, 26), (4, 27)]
            feet = [(8, 28), (9, 28), (10, 28), (4, 28), (5, 28)]
        elif frame_index % 4 == 2:
            near = [(7, 24), (8, 24), (7, 25), (8, 25), (7, 26), (8, 26), (7, 27), (8, 27)]
            rear = [(5, 24), (5, 25), (5, 26), (5, 27)]
            feet = [(7, 28), (8, 28), (9, 28), (5, 28), (6, 28)]
        else:
            near = [(7, 24), (8, 24), (7, 25), (8, 25), (7, 26), (8, 26), (7, 27), (8, 27)]
            rear = [(5, 24), (5, 25), (5, 26), (5, 27)]
            feet = [(7, 28), (8, 28), (9, 28), (5, 28), (6, 28)]
