...
| `ack-pending` explicitly acknowledges one reviewed inbox message by role and id, supports optional drift checks, stamps `refs.ackedAt`, does not call `recv`, and preserves existing `ack` semantics for processing messages. | `tests/test_queue.py::MessageQueueTests.test_ack_pending_moves_inbox_to_processed_with_acked_at`, `tests/test_queue.py::MessageQueueTests.test_ack_pending_optional_expect_flags_match_and_cli_support`, `tests/test_queue.py::MessageQueueTests.test_ack_pending_missing_or_wrong_state_fails_without_moving`, `tests/test_queue.py::MessageQueueTests.test_ack_pending_expect_flag_mismatches_fail_closed`, `tests/test_queue.py::MessageQueueTests.test_ack_pending_duplicate_inbox_id_fails_closed`, `tests/test_queue.py::MessageQueueTests.test_ack_pending_without_expect_flags_preserves_message_fields_and_log`, `tests/test_queue.py::MessageQueueTests.test_ack_still_requires_processing_not_inbox`, `tests/test_queue.py::MessageQueueTests.test_ack_pending_docs_and_spec_matrix_are_safe` |
...
| The Codex tmux worker is opt-in, manual bounded by default, uses the executor bridge, treats instruction bodies as prompt data instead of shell, blocks dirty Git worktrees by default, and acknowledges only after structured success. | `tests/test_queue.py::MessageQueueTests.test_codex_executor_success_acks_after_codex_exit_zero`, `tests/test_queue.py::MessageQueueTests.test_codex_executor_nonzero_does_not_ack`, `tests/test_queue.py::MessageQueueTests.test_codex_executor_requires_explicit_repo`, `tests/test_queue.py::MessageQueueTests.test_codex_executor_dirty_git_repo_blocks_before_codex`, `tests/test_queue.py::MessageQueueTests.test_codex_worker_docs_and_scripts_are_safe` |
...
| `refs.sourceChannel`, `refs.reportTarget`, `refs.repo`, and `refs.workspace` are optional traceability conventions for cross-surface, repository, and workstream context, not routing or access-control fields. | `tests/test_queue.py::MessageQueueTests.test_send_optional_source_metadata_refs_are_backward_compatible`, `tests/test_queue.py::MessageQueueTests.test_cli_send_optional_correlation_and_source_flags_write_refs_only`, `tests/test_queue.py::MessageQueueTests.test_spec_matrix_and_correlation_docs_are_safe` |
| Source and correlation metadata is backward-compatible and does not change queue delivery, priority, acknowledgement, retry, pruning, queue selection, or routing behavior. | `tests/test_queue.py::MessageQueueTests.test_spec_matrix_and_correlation_docs_are_safe`, `tests/test_queue.py::MessageQueueTests.test_send_optional_source_metadata_refs_are_backward_compatible`, `tests/test_queue.py::MessageQueueTests.test_cli_send_optional_correlation_and_source_flags_write_refs_only`, `tests/test_queue.py::MessageQueueTests.test_queue_reconciliation_policy_docs_are_safe`, `tests/test_queue.py::MessageQueueTests.test_queue_reconciliation_report_helper_is_read_only`, `tests/test_queue.py::MessageQueueTests.test_helper_environment_contract_is_documented_and_safe` |
| Clean-clone operator docs distinguish repository-provided workflow from environment-specific roles, credentials, notification surfaces, and artifact locations. | `tests/test_queue.py::MessageQueueTests.test_operator_runbook_and_api_docs_are_current_and_safe` |
| Example workflows are runnable, temporary-root bounded, public-safe, and demonstrate source metadata as traceability-only. | `tests/test_queue.py::MessageQueueTests.test_two_agent_example_workflow_is_runnable_and_safe` |
